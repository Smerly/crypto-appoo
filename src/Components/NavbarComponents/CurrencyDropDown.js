...
function CurrencyDropDown(props) {
    ...
    return (
        <div>
            <DropdownButton data-dropdown-toggle="dropdownRadioBgHover" className='dropdown-button bg-gray' onClick={show}>{CURRENTcy.currency}</DropdownButton>
